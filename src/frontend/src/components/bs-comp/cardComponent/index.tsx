...
export default function CardComponent<T>({
  ...
  // 侧边弹窗列表（sheet）
  if (type === 'sheet') return <Card className="group max-h-[146px] w-[316px] cursor-pointer bg-[#F7F9FC] dark:bg-background-main dark:hover:bg-background-login hover:bg-[#E0E0E0] hover:shadow-none relative" onClick={onClick}>
